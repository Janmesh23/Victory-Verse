...
//           if (
//             eventData.creator.toLowerCase() === walletAddress.toLowerCase() &&
...
//       // Call the contract's declareWinner function (this mints NFT and tokens as per your contract logic)
//       const tx = await contract.declareWinner(selectedEventId, selectedWinner);
//       await tx.wait();
//       alert("Winner declared successfully!");

//       // Remove this event from the list (or refresh events)
...
//                       selectedWinner === participant ? "bg-green-600" : "bg-gray-700"
//                     }`}
//                   >
//                     {participant}
//                   </li>
